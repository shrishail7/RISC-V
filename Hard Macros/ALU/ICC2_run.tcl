...
../../../dc_compiler/ref/CLIBs/saed32_sram_lp.ndm} alu

#reading netlist and SDC
read_verilog ../extracted_files/alu.v
#read_sdc ../../dc_compiler/extracted_files/alu/alu.sdc

#floor plan
link_design
initialize_floorplan -core_offset {4} -side_ratio {2 2} -core_utilization 0.65
...
#script writing
write_script -force -format icc2 -output ../reports/alu_spef
write_parasitics -output ../reports/spef_generation_1
write_sdf ../results/alu.sdf
write_verilog ../results/alu.v
#write_sdc -output ../results/alu.sdc
create_abstract
create_frame -block_all true
write_gds -compress -hierarchy all -long_names -keep_data_type ../results/alu.gds
